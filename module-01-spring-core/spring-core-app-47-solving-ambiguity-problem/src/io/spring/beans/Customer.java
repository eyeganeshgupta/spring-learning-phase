...
public class Customer {
    ...
    public Customer(String customerId, String name, String email, String phoneNumber, Account primaryAccount, Account secondaryAccount) {
    ...
    public void displayDetails() {
        ...
        System.out.println(primaryAccount.toString().replace("=", ":").replace("{", "").replace("}", "").replace(",", "\n"));
        System.out.println("\nSecondary Account Details:");
        System.out.println(secondaryAccount.toString().replace("=", ":").replace("{", "").replace("}", "").replace(",", "\n"));
        System.out.println(border);
    }
