...
public class Actor {
    ...
    // Constructor
    public Actor(@Value("${actor.firstName}") String firstName, @Value("${actor.lastName}") String lastName, @Value("${actor.age}") int age, @Value("${actor.gender}") String gender, @Value("${actor.nationality}") String nationality, @Value("${actor.numberOfAwards}") int numberOfAwards, @Value("${actor.famousMovies}") List<String> famousMovies) {
