...
---------------------
    👉 If we have multiple constructors and we have not used the @Autowired with any of them then Spring will try to use the non-parameterized constructor to create our bean.
*/
...
public class Programmer {
    ...
    // Since @Autowired is missing Spring will use non-param constructor for creating Programmer bean.
    public Programmer() {
        System.out.println("==== Programmer bean created! ====");
    }
