...
---------------------------
    ❓ Can we create DevelopmentEnvironment bean using @Bean and then get it injected in the Programmer bean?
        📢 Yes, we can easily create the DevelopmentEnvironment bean using @Bean and then get it injected in Programmer bean using ‘@Autowired’
*/
