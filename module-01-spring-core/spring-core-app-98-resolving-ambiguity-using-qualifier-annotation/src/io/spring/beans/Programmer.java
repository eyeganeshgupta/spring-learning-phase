...
public class Programmer {
    ...
    // ╰┈➤ This will inform Spring that we want the bean with the name: ‘developmentEnvironment02’ to be injected.
    @Autowired
    public Programmer(@Value("Ganesh Gupta") String name, @Value("21") int age,
                      ...
                      @Value("true") boolean remoteWorking, @Qualifier("developmentEnvironment02") DevelopmentEnvironment developmentEnvironment) {
        this.name = name;
        this.age = age;
        this.gender = gender;
